...
},{"./gsap-core.js":"../../node_modules/gsap/gsap-core.js","./CSSPlugin.js":"../../node_modules/gsap/CSSPlugin.js"}],"../../node_modules/gsap/SplitText.js":[function(require,module,exports) {
"use strict";
...
let SplitText = exports.default = exports.SplitText = _SplitText;
...
var gsap,
  ...
  _recordScrollPositions = function _recordScrollPositions() {
    return _Observer._scrollers.forEach(function (obj) {
  ...
  _proto.init = function init(vars, animation) {
    ...
    if (animation && animation.add && !change) {
      ...
      self.update = function () {
        ...
        _Observer._scrollers.cache++; // otherwise a cached scroll position may get used in the refresh() in a very rare scenario, like if ScrollTriggers are created inside a DOMContentLoaded event and the queued requestAnimationFrame() fires beforehand. See https://gsap.com/community/forums/topic/41267-scrolltrigger-breaks-on-refresh-when-using-domcontentloaded/
...
},{"./Observer.js":"../../node_modules/gsap/Observer.js"}],"functions.js":[function(require,module,exports) {
"use strict";
...
_gsap.gsap.registerPlugin(_SplitText.default, _ScrollTrigger.default);
...
function hanldeTeamItem() {
  var teamList = document.querySelector(".block-teams__list");
  if (!teamList) return;
  teamList.addEventListener("mousemove", function (e) {
    var _t = e.target.closest(".team-card");
    if (!_t) return;
    var r = _t.getBoundingClientRect(),
      x = e.clientX - r.x,
      y = e.clientY - r.y;
    _t.style.setProperty("--x", "".concat(x, "px"));
    _t.style.setProperty("--y", "".concat(y, "px"));
    updateMedia(_t);
  });
  teamList.addEventListener("mouseleave", function (e) {
    var item = e.target.closest(".team-card");
    if (!item) return;
    resetVideo(item);
  }, true);
  function updateMedia(item) {
    if (item.dataset.loaded === "true") return;
    var type = item.dataset.mediaType;
    var media = item.dataset.media;
    if (!type || !media) return;
    if (type === "image") {
      var img = item.querySelector(".team-item-media img");
      if (img) {
        img.src = media;
      }
    }
    if (type === "video") {
      ...
      (_video$play = video.play) === null || _video$play === void 0 || _video$play.call(video);
    }
...
function initAnimationFadeInText() {
  var elements = document.querySelectorAll(".wp-block-heading-stagger-random");
...
function initTextBottomToUpAnim() {
  var elements = document.querySelectorAll(".wp-block-heading-fadein-chars");
  if (!elements.length) return;
  var delay = 0;
  var duration = 1;
  elements.forEach(function (el) {
...
},{"gsap":"../../node_modules/gsap/index.js","gsap/SplitText":"../../node_modules/gsap/SplitText.js","gsap/ScrollTrigger":"../../node_modules/gsap/ScrollTrigger.js"}],"blocks/counter.js":[function(require,module,exports) {
"use strict";
...
var _default = exports.default = {
  init: function init() {
    var blocks = document.querySelectorAll('.counter-item');
    if (!blocks.length) return;
    blocks.forEach(function (block) {
      var counters = block.querySelectorAll('.counter-number');
      if (!counters.length) return;
      function animateFormattedCounter(el) {
        ...
        var numberStr = numberMatch ? numberMatch[0] : '0';
        var decimalSeparator = '.';
        if (numberStr.includes(',') && numberStr.includes('.')) {
          decimalSeparator = numberStr.lastIndexOf(',') > numberStr.lastIndexOf('.') ? ',' : '.';
        } else if (numberStr.includes(',')) {
          decimalSeparator = ',';
        }
        var decimalDigits = 0;
        var decimalPart = numberStr.split(decimalSeparator)[1];
        if (decimalPart) decimalDigits = decimalPart.length;
        var normalized = numberStr.replace(new RegExp("[^\\d".concat(decimalSeparator, "]"), 'g'), '');
        if (decimalSeparator === ',') normalized = normalized.replace(',', '.');
        var target = parseFloat(normalized) || 0;
        var start = 0;
        var startTime = performance.now();
        var thousandSeparator = decimalSeparator === '.' ? ',' : '.';
        function formatNumber(num) {
          var parts = num.toFixed(decimalDigits).split('.');
          var intPart = parts[0];
          var decPart = parts[1];
          if (thousandSeparator) intPart = intPart.replace(/\B(?=(\d{3})+(?!\d))/g, thousandSeparator);
          return decimalDigits > 0 ? "".concat(intPart).concat(decimalSeparator).concat(decPart) : intPart;
        }
        ...
        function update(now) {
          ...
          var current = eased * (target - start) + start;
        ...
        entries.forEach(function (entry) {
          if (entry.isIntersecting) {
            counters.forEach(function (el) {
              return animateFormattedCounter(el);
            });
            observer.unobserve(entry.target);
          }
        });
...
exports.a = setCSSProperty;
exports.b = elementParents;
exports.c = createElement;
exports.d = elementOffset;
exports.e = elementChildren;
exports.f = now;
exports.g = getSlideTransformEl;
exports.h = elementOuterSize;
exports.i = elementIndex;
exports.j = classesToTokens;
exports.k = getTranslate;
exports.l = elementTransitionEnd;
exports.m = makeElementsArray;
exports.n = nextTick;
exports.o = isObject;
exports.p = getRotateFix;
exports.q = elementStyle;
exports.r = elementNextAll;
exports.s = setInnerHTML;
...
function Observer(_ref) {
  ...
  const init = () => {
    ...
    if (swiper.params.observeParents) {
      const containerParents = (0, _utils.b)(swiper.hostEl);
...
function updateSize() {
  ...
  // Subtract paddings
  width = width - parseInt((0, _utils.q)(el, 'padding-left') || 0, 10) - parseInt((0, _utils.q)(el, 'padding-right') || 0, 10);
  height = height - parseInt((0, _utils.q)(el, 'padding-top') || 0, 10) - parseInt((0, _utils.q)(el, 'padding-bottom') || 0, 10);
...
function updateSlides() {
  ...
  if (params.centeredSlides && params.cssMode) {
    (0, _utils.a)(wrapperEl, '--swiper-centered-offset-before', '');
    (0, _utils.a)(wrapperEl, '--swiper-centered-offset-after', '');
  }
  ...
  for (let i = 0; i < slidesLength; i += 1) {
    ...
    if (slides[i] && (0, _utils.q)(slide, 'display') === 'none') continue; // eslint-disable-line
    ...
    if (params.slidesPerView === 'auto') {
      ...
      if (params.roundLengths) {
        slideSize = swiper.isHorizontal() ? (0, _utils.h)(slide, 'width', true) : (0, _utils.h)(slide, 'height', true);
      } else {
        // eslint-disable-next-line
  ...
  if (params.centeredSlides && params.cssMode && !params.centeredSlidesBounds) {
    (0, _utils.a)(wrapperEl, '--swiper-centered-offset-before', "".concat(-snapGrid[0], "px"));
    (0, _utils.a)(wrapperEl, '--swiper-centered-offset-after', "".concat(swiper.size / 2 - slidesSizesGrid[slidesSizesGrid.length - 1] / 2, "px"));
...
function updateSlidesClasses() {
  ...
  if (activeSlide) {
    if (!gridEnabled) {
      // Next Slide
      nextSlide = (0, _utils.r)(activeSlide, ".".concat(params.slideClass, ", swiper-slide"))[0];
      if (params.loop && !nextSlide) {
        nextSlide = slides[0];
      }

      // Prev Slide
      prevSlide = (0, _utils.t)(activeSlide, ".".concat(params.slideClass, ", swiper-slide"))[0];
...
function getSwiperTranslate(axis) {
  ...
  let currentTranslate = (0, _utils.k)(wrapperEl, axis);
...
function loopCreate(slideRealIndex, initial) {
  ...
  const clearBlankSlides = () => {
    const slides = (0, _utils.e)(slidesEl, ".".concat(params.slideBlankClass));
    slides.forEach(el => {
      el.remove();
    });
    if (slides.length > 0) {
  ...
  if (shouldFillGroup) {
    if (params.loopAddBlankSlides) {
      ...
      (0, _utils.v)('Swiper Loop Warning: The number of slides is not even to slidesPerGroup, loop mode may not function properly. You need to add more slides (or make duplicates, or empty slides)');
    }
    initSlides();
    ...
    if (params.loopAddBlankSlides) {
      ...
      (0, _utils.v)('Swiper Loop Warning: The number of slides is not even to grid.rows, loop mode may not function properly. You need to add more slides (or make duplicates, or empty slides)');
    }
    initSlides();
  } else {
    initSlides();
...
function loopFix(_temp) {
  ...
  if (slides.length < slidesPerView + loopedSlides || swiper.params.effect === 'cards' && slides.length < slidesPerView + loopedSlides * 2) {
    (0, _utils.v)('Swiper Loop Warning: The number of slides is not enough for loop mode, it will be disabled or not function properly. You need to add more slides (or make duplicates) or lower the values of slidesPerView and slidesPerGroup parameters');
  } else if (gridEnabled && params.grid.fill === 'row') {
    (0, _utils.v)('Swiper Loop Warning: Loop mode is not compatible with grid.fill = `row`');
  }
...
function onTouchStart(event) {
  ...
  if (params.touchEventsTarget === 'wrapper') {
    if (!(0, _utils.w)(targetEl, swiper.wrapperEl)) return;
  }
  ...
  data.touchStartTime = (0, _utils.f)();
  swiper.allowClick = true;
  swiper.updateSize();
...
function setBreakpoint() {
  ...
  (0, _utils.x)(swiper.params, breakpointParams);
...
function moduleExtendParams(params, allModulesParams) {
  return function extendParams(obj) {
    ...
    if (typeof moduleParams !== 'object' || moduleParams === null) {
      (0, _utils.x)(allModulesParams, obj);
      return;
    }
...
class Swiper {
  constructor() {
    ...
    if (!params) params = {};
    params = (0, _utils.x)({}, params);
    if (el && !params.el) params.el = el;
    const document = (0, _ssrWindowEsm.g)();
    if (params.el && typeof params.el === 'string' && document.querySelectorAll(params.el).length > 1) {
      const swipers = [];
      document.querySelectorAll(params.el).forEach(containerEl => {
        const newParams = (0, _utils.x)({}, params, {
          el: containerEl
        });
    ...
    const swiperParams = (0, _utils.x)({}, defaults, allModulesParams);

    // Extend defaults with passed params
    swiper.params = (0, _utils.x)({}, swiperParams, extendedDefaults, params);
    swiper.originalParams = (0, _utils.x)({}, swiper.params);
    swiper.passedParams = (0, _utils.x)({}, params);
  ...
  getSlideIndex(slideEl) {
    ...
    const slides = (0, _utils.e)(slidesEl, ".".concat(params.slideClass, ", swiper-slide"));
    const firstSlideIndex = (0, _utils.i)(slides[0]);
    return (0, _utils.i)(slideEl) - firstSlideIndex;
  }
  ...
  mount(element) {
    ...
    Object.assign(swiper, {
      ...
      mounted: true,
      // RTL
      rtl: el.dir.toLowerCase() === 'rtl' || (0, _utils.q)(el, 'direction') === 'rtl',
      rtlTranslate: swiper.params.direction === 'horizontal' && (el.dir.toLowerCase() === 'rtl' || (0, _utils.q)(el, 'direction') === 'rtl'),
      wrongRTL: (0, _utils.q)(wrapperEl, 'display') === '-webkit-box'
    });
    return true;
  }
  init(el) {
  ...
  static extendDefaults(newDefaults) {
    (0, _utils.x)(extendedDefaults, newDefaults);
  }
...
function Virtual(_ref) {
  ...
  on('init update resize', () => {
    if (!swiper.params.virtual.enabled) return;
    if (swiper.params.cssMode) {
      (0, _utils.a)(swiper.wrapperEl, '--swiper-virtual-size', "".concat(swiper.virtualSize, "px"));
    }
  });
  Object.assign(swiper.virtual, {
...
function Keyboard(_ref) {
  ...
  function handle(event) {
    ...
    if (swiper.params.keyboard.onlyInViewport && (isPageUp || isPageDown || isArrowLeft || isArrowRight || isArrowUp || isArrowDown)) {
      ...
      if ((0, _utils.b)(swiper.el, ".".concat(swiper.params.slideClass, ", swiper-slide")).length > 0 && (0, _utils.b)(swiper.el, ".".concat(swiper.params.slideActiveClass)).length === 0) {
        return undefined;
      }
      const el = swiper.el;
      ...
      const swiperOffset = (0, _utils.d)(el);
...
function Mousewheel(_ref) {
  ...
  function animateSlider(newEvent) {
    ...
    if (swiper.params.mousewheel.thresholdTime && (0, _utils.f)() - lastScrollTime < swiper.params.mousewheel.thresholdTime) {
    ...
    if (newEvent.delta >= 6 && (0, _utils.f)() - lastScrollTime < 60) {
...
function Navigation(_ref) {
  ...
  function init() {
    ...
    nextEl = (0, _utils.m)(nextEl);
    prevEl = (0, _utils.m)(prevEl);
...
},{"../shared/create-element-if-not-defined.mjs":"../../node_modules/swiper/shared/create-element-if-not-defined.mjs","../shared/utils.mjs":"../../node_modules/swiper/shared/utils.mjs"}],"../../node_modules/swiper/shared/classes-to-selector.mjs":[function(require,module,exports) {
"use strict";
...
function Pagination(_ref) {
  ...
  function onBulletClick(e) {
    ...
    e.preventDefault();
    const index = (0, _utils.i)(bulletEl) * swiper.params.slidesPerGroup;
    if (swiper.params.loop) {
  ...
  function update() {
    ...
    if (params.type === 'bullets' && swiper.pagination.bullets && swiper.pagination.bullets.length > 0) {
      ...
      if (params.dynamicBullets) {
        bulletSize = (0, _utils.h)(bullets[0], swiper.isHorizontal() ? 'width' : 'height', true);
        el.forEach(subEl => {
      ...
      if (el.length > 1) {
        bullets.forEach(bullet => {
          const bulletIndex = (0, _utils.i)(bullet);
    ...
    el.forEach((subEl, subElIndex) => {
      ...
      if (params.type === 'custom' && params.renderCustom) {
        (0, _utils.s)(subEl, params.renderCustom(swiper, current + 1, total));
  ...
  function render() {
    ...
    el.forEach(subEl => {
      if (params.type !== 'custom') {
        (0, _utils.s)(subEl, paginationHTML || '');
      }
      if (params.type === 'bullets') {
  ...
  function init() {
    ...
    if (swiper.params.uniqueNavElements && typeof params.el === 'string' && Array.isArray(el) && el.length > 1) {
      ...
      if (el.length > 1) {
        el = el.find(subEl => {
          if ((0, _utils.b)(subEl, '.swiper')[0] !== swiper.el) return false;
          return true;
        });
      }
    }
  ...
  on('click', (_s, e) => {
    const targetEl = e.target;
    const el = (0, _utils.m)(swiper.pagination.el);
...
function Scrollbar(_ref) {
  ...
  function setDragPosition(e) {
    ...
    let positionRatio;
    positionRatio = (getPointerPosition(e) - (0, _utils.d)(el)[swiper.isHorizontal() ? 'left' : 'top'] - (dragStartPos !== null ? dragStartPos : dragSize / 2)) / (trackSize - dragSize);
  ...
  function init() {
    ...
    if (el) {
      el.classList[swiper.enabled ? 'remove' : 'add'](...(0, _utils.j)(swiper.params.scrollbar.lockClass));
    }
  }
  function destroy() {
    const params = swiper.params.scrollbar;
    ...
    if (el) {
      el.classList.remove(...(0, _utils.j)(swiper.isHorizontal() ? params.horizontalClass : params.verticalClass));
    }
    disableDraggable();
  }
  on('changeDirection', () => {
  ...
  const enable = () => {
    swiper.el.classList.remove(...(0, _utils.j)(swiper.params.scrollbar.scrollbarDisabledClass));
    if (swiper.scrollbar.el) {
      swiper.scrollbar.el.classList.remove(...(0, _utils.j)(swiper.params.scrollbar.scrollbarDisabledClass));
    }
    init();
    updateSize();
    setTranslate();
  ...
  const disable = () => {
    swiper.el.classList.add(...(0, _utils.j)(swiper.params.scrollbar.scrollbarDisabledClass));
    if (swiper.scrollbar.el) {
      swiper.scrollbar.el.classList.add(...(0, _utils.j)(swiper.params.scrollbar.scrollbarDisabledClass));
    }
    destroy();
  };
...
function Zoom(_ref) {
  ...
  function onGestureStart(e) {
    ...
    if (!gesture.slideEl) {
      ...
      if (imageEl) {
        gesture.imageWrapEl = (0, _utils.b)(gesture.imageEl, ".".concat(params.containerClass))[0];
      } else {
  ...
  function onTouchMove(e) {
    ...
    if (!image.isMoved) {
      ...
      image.startX = (0, _utils.k)(gesture.imageWrapEl, 'x') || 0;
      image.startY = (0, _utils.k)(gesture.imageWrapEl, 'y') || 0;
  ...
  function zoomIn(e) {
    ...
    if (e && !(currentScale === 1 && forceZoomRatio)) {
      ...
      offsetX = (0, _utils.d)(gesture.slideEl).left + window.scrollX;
      offsetY = (0, _utils.d)(gesture.slideEl).top + window.scrollY;
...
function A11y(_ref) {
  ...
  function notify(message) {
    ...
    (0, _utils.s)(notification, message);
  }
  ...
  function onEnterOrSpaceKey(e) {
    ...
    if (swiper.navigation && swiper.navigation.prevEl && swiper.navigation.nextEl) {
      const prevEls = (0, _utils.m)(swiper.navigation.prevEl);
      const nextEls = (0, _utils.m)(swiper.navigation.nextEl);
    ...
    swiper.pagination.bullets.forEach(bulletEl => {
      if (swiper.params.pagination.clickable) {
        ...
        if (!swiper.params.pagination.renderBullet) {
          ...
          addElLabel(bulletEl, params.paginationBulletMessage.replace(/\{\{index\}\}/, (0, _utils.i)(bulletEl) + 1));
        }
      }
  ...
  const init = () => {
    ...
    if (hasClickablePagination()) {
      const paginationEl = (0, _utils.m)(swiper.pagination.el);
...
},{"../shared/ssr-window.esm.mjs":"../../node_modules/swiper/shared/ssr-window.esm.mjs","../shared/classes-to-selector.mjs":"../../node_modules/swiper/shared/classes-to-selector.mjs","../shared/utils.mjs":"../../node_modules/swiper/shared/utils.mjs"}],"../../node_modules/swiper/modules/history.mjs":[function(require,module,exports) {
"use strict";
...
function Thumb(_ref) {
  ...
  function init() {
    ...
    } else if ((0, _utils.o)(thumbsParams.swiper)) {
  ...
  function onTouchEnd(_ref2) {
    ...
    if (params.freeMode.momentum) {
      if (data.velocities.length > 1) {
        ...
        if (time > 150 || (0, _utils.f)() - lastMoveEvent.time > 300) {
          swiper.velocity = 0;
        }
      } else {
        swiper.velocity = 0;
...
},{"../shared/utils.mjs":"../../node_modules/swiper/shared/utils.mjs"}],"../../node_modules/swiper/shared/effect-init.mjs":[function(require,module,exports) {
"use strict";
...
function effectTarget(effectParams, slideEl) {
  const transformEl = (0, _utils.g)(slideEl);
...
function EffectFade(_ref) {
  ...
  const setTransition = duration => {
    const transformElements = swiper.slides.map(slideEl => (0, _utils.g)(slideEl));
...
function createShadow(suffix, slideEl, side) {
  ...
  const shadowContainer = (0, _utils.g)(slideEl);
...
function EffectFlip(_ref) {
  ...
  const setTranslate = () => {
    ...
    const rotateFix = (0, _utils.p)(swiper);
    for (let i = 0; i < slides.length; i += 1) {
      const slideEl = slides[i];
      let progress = slideEl.progress;
      if (swiper.params.flipEffect.limitRotation) {
...
var heroCarousel = function heroCarousel() {
  var $blocks = document.querySelectorAll(".hero-block");
  if (!$blocks.length) return;
  $blocks.forEach(function ($block) {
    var _data$speed;
    var swiperEl = $block.querySelector(".hero-block__swiper");
    if (!swiperEl) return;
    var dataStr = swiperEl.getAttribute("data-carousel");
    var data = dataStr ? JSON.parse(dataStr) : {};
    var paginationEl = $block.querySelector(".swiper-pagination");
    var totalSlides = swiperEl.querySelectorAll(".swiper-wrapper > .hero-block__slide").length;
    ...
    var speed = Math.max((_data$speed = data.speed) !== null && _data$speed !== void 0 ? _data$speed : 1100, 1000);
    var swiper = new _swiper.default(swiperEl, {
      modules: [_modules.Pagination, _modules.EffectFade],
      slidesPerView: 1,
      effect: "fade",
      fadeEffect: {
        crossFade: true
    ...
    paginationEl === null || paginationEl === void 0 || paginationEl.addEventListener("click", function (e) {
      var bulletEl = e.target.closest(".swiper-pagination-bullet");
      if (!bulletEl) return;
      var index = _toConsumableArray(paginationEl.querySelectorAll(".swiper-pagination-bullet")).indexOf(bulletEl);
      if (index > -1) swiper.slideTo(index);
    });
    if (data.autoplay && totalSlides > 1) {
      var _data$autoplaySpeed;
      var delay = (_data$autoplaySpeed = data.autoplaySpeed) !== null && _data$autoplaySpeed !== void 0 ? _data$autoplaySpeed : 6000;
...
var testimonialsCarousel = function testimonialsCarousel() {
  ...
  $blocks.forEach(function ($block, index) {
    var _sliderData$speed, _sliderData$autoplayS;
    var swiperEl = $block.querySelector(".testimonials-carousel");
    var sliderDataStr = swiperEl.getAttribute("data-carousel");
    var sliderData = JSON.parse(sliderDataStr);
    var navContainer = $block.querySelector(".block-testimonials-carousel__nav");
    var swiper = new _swiper.default(swiperEl, {
      modules: [_modules.Pagination, _modules.Autoplay, _modules.EffectFade, _modules.Navigation],
      slidesPerView: 1.1,
      spaceBetween: 20,
      loop: sliderData.infinite || false,
      speed: (_sliderData$speed = sliderData.speed) !== null && _sliderData$speed !== void 0 ? _sliderData$speed : 500,
      keyboard: true,
      slideToClickedSlide: false,
      grabCursor: true,
      parallax: true,
      ...
      autoplay: sliderData.autoplay ? {
        delay: (_sliderData$autoplayS = sliderData.autoplaySpeed) !== null && _sliderData$autoplayS !== void 0 ? _sliderData$autoplayS : 3000,
        disableOnInteraction: false
      } : false,
      navigation: {
        nextEl: navContainer === null || navContainer === void 0 ? void 0 : navContainer.querySelector(".swiper-button-next"),
        prevEl: navContainer === null || navContainer === void 0 ? void 0 : navContainer.querySelector(".swiper-button-prev")
      },
      breakpoints: {
        1200: {
          slidesPerView: "auto"
...
function logoCarousel() {
  var carousel = document.querySelector(".block-logo-carousel .swiper");
  if (!carousel) return;
  var speed = parseInt(carousel.dataset.speed) || 5000;
  var spaceBetween = parseInt(carousel.dataset.spacebetween) || 100;
...
function galleryCarousel() {
  var carousel = document.querySelector(".block-gallery-carousel .swiper");
  if (!carousel) return;
  var speed = parseInt(carousel.dataset.speed) || 5000;
  var spaceBetween = parseInt(carousel.dataset.spacebetween) || 20;
  var swiper = new _swiper.default(carousel, {
    modules: [_modules.Autoplay],
    loop: true,
    slidesPerView: "auto",
...
function productCarousel() {
  var $blocks = document.querySelectorAll(".block-product-carousel");
  if (!$blocks.length) return;
  $blocks.forEach(function ($block) {
    ...
    var dataStr = swiperEl.getAttribute("data-carousel");
    var data = dataStr ? JSON.parse(dataStr) : {};
    var slidesPerView = data.slidesPerView || 3;
    new _swiper.default(swiperEl, {
      modules: [_modules.Navigation, _modules.Pagination, _modules.Autoplay],
      slidesPerView: slidesPerView,
...
function beforeAfterCarousel() {
  var $blocks = document.querySelectorAll(".block-before-after-carousel");
  if (!$blocks.length) return;
  $blocks.forEach(function ($block) {
    var swiperEl = $block.querySelector(".block-before-after-carousel__inner");
    if (!swiperEl) return;
    var dataStr = swiperEl.getAttribute("data-carousel");
    var data = dataStr ? JSON.parse(dataStr) : {};
    new _swiper.default(swiperEl, {
...
},{"swiper":"../../node_modules/swiper/swiper.mjs","swiper/modules":"../../node_modules/swiper/modules/index.mjs"}],"blocks/insights.js":[function(require,module,exports) {
"use strict";
...
var _default = exports.default = {
  init: function init() {
    var block = document.querySelector(".block-insights");
    if (!block) return;
    var dropdown = document.querySelector(".block-insights__drowdown");
    var labelDropdown = document.querySelector(".block-insights__drowdown--label");
    var dataInsight = document.querySelector(".block-insights__inner");
    var infinite = document.getElementById("block-insights__infinite");
    var insightsGrid = document.querySelector(".block-insights__grid");
    var maxPages = null;
    var loading = false;

    // Toggle dropdown
    labelDropdown === null || labelDropdown === void 0 || labelDropdown.addEventListener("click", function (event) {
      event.preventDefault();
      dropdown.classList.toggle("active");
    });

    // Category item click
    dropdown === null || dropdown === void 0 || dropdown.querySelectorAll(".block-insights__drowdown--item").forEach(function (item) {
      item.addEventListener("click", function (event) {
        ...
        dropdown.classList.toggle("active");
        var query = dataInsight.dataset.query;
        var cat_id = dataInsight.dataset.id;
        var paged = 1;
        maxPages = null;
        loading = false;
        fetchData({
      ...
      var observer = new IntersectionObserver(function (entries) {
        entries.forEach(function (entry) {
          if (entry.isIntersecting && !loading) {
            var paged = parseInt(dataInsight.dataset.paged) + 1;
    ...
    function fetchData() {
      ...
      fetch(block_script.ajax_url, {
        ...
        return console.error("AJAX Error:", error);
      }).finally(function () {
        loading = false;
...
},{}],"blocks/team.js":[function(require,module,exports) {
"use strict";
...
var _default = exports.default = {
  init: function init() {
    var block = document.querySelector('.block-teams-list');
    if (!block) return;
    var dropdown = document.querySelector('.block-teams__drowdown');
    var labelDropdown = document.querySelector('.block-teams__drowdown--label');
    var lmContainer = block.querySelector('.block-teams-list__load-more');
    var btnLoadMore = block.querySelector('.btn-load-more');
    var teamsGrid = document.querySelector('.block-teams__list');
    var query = teamsGrid.dataset.query;
    var dropdownLoading = block.querySelector('.teams-filter__loading');
    function fetchData() {
      var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      var scroll = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
      ...
      fetch(block_script.ajax_url, {
        ...
        if (teamsGrid) {
          if (scroll) {
            ...
            btnLoadMore === null || btnLoadMore === void 0 || btnLoadMore.scrollIntoView({
              behavior: 'smooth',
              block: 'end'
            });
          } else {
    ...
    btnLoadMore === null || btnLoadMore === void 0 || btnLoadMore.addEventListener('click', function () {
      var paged = parseInt(teamsGrid.dataset.paged) + 1;
      var catID = dropdown.dataset.cate;
    ...
    // Category item click
    dropdown === null || dropdown === void 0 || dropdown.querySelectorAll('.block-teams__drowdown--item').forEach(function (item) {
      item.addEventListener('click', function (event) {
        event.preventDefault();
        labelDropdown.textContent = item.textContent;
    ...
    var popupBody = popup === null || popup === void 0 ? void 0 : popup.querySelector('.team-popup__body');
    var popupClose = popup === null || popup === void 0 ? void 0 : popup.querySelector('.team-popup__close');
    var popupOverlay = popup === null || popup === void 0 ? void 0 : popup.querySelector('.team-popup__overlay');
    function openPopup() {
      var _window$lenis;
      popup.classList.remove('hidden');
      document.body.classList.add('team-popup-open');
      (_window$lenis = window.lenis) === null || _window$lenis === void 0 || _window$lenis.stop();
    }
    function closePopup() {
      var _window$lenis2;
      ...
      (_window$lenis2 = window.lenis) === null || _window$lenis2 === void 0 || _window$lenis2.start();
    }
    popupClose === null || popupClose === void 0 || popupClose.addEventListener("click", closePopup);
    popupOverlay === null || popupOverlay === void 0 || popupOverlay.addEventListener("click", closePopup);
    ...
    document.addEventListener("click", function (e) {
      ...
      if (!card) return;
      var teamID = card.dataset.id;
      if (!teamID) return;
      popupBody.innerHTML = "";
      (_popup$querySelector = popup.querySelector('.team-popup__loading')) === null || _popup$querySelector === void 0 || _popup$querySelector.classList.add('active');
      openPopup();
      fetch(block_script.ajax_url, {
        method: "POST",
        headers: {
        ...
        var _popup$querySelector2;
        (_popup$querySelector2 = popup.querySelector('.team-popup__loading')) === null || _popup$querySelector2 === void 0 || _popup$querySelector2.classList.remove('active');
      });
    });
  }
};
},{}],"../../shared/team-experts-carousel.js":[function(require,module,exports) {
"use strict";
...
exports.default = void 0;
exports.initTeamExpertsBlock = initTeamExpertsBlock;
var _swiper = _interopRequireDefault(require("swiper"));
var _modules = require("swiper/modules");
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
/**
...
},{"swiper":"../../node_modules/swiper/swiper.mjs","swiper/modules":"../../node_modules/swiper/modules/index.mjs"}],"blocks/team-experts.js":[function(require,module,exports) {
"use strict";
...
exports.default = void 0;
var _teamExpertsCarousel = _interopRequireDefault(require("../../../shared/team-experts-carousel"));
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
var _default = exports.default = _teamExpertsCarousel.default;
},{"../../../shared/team-experts-carousel":"../../shared/team-experts-carousel.js"}],"blocks/sectors.js":[function(require,module,exports) {
"use strict";
...
var _default = exports.default = {
  init: function init() {
    ...
    var floating = document.querySelector(".sector-floating-media");
    var img = floating === null || floating === void 0 ? void 0 : floating.querySelector("img");
    ...
    function moveToItem(item) {
      ...
      var topPosition = itemOffset + itemHeight / 2;
      floating.style.transform = "translate(-50%, ".concat(topPosition, "px) translateY(-50%)");
    }
  }
};
},{}],"blocks/content-media.js":[function(require,module,exports) {
"use strict";
...
var _default = exports.default = {
  init: function init() {
    var initBlock = function initBlock(wrapper) {
      var left = wrapper.querySelector(".thumb-list");
      var indicator = left === null || left === void 0 ? void 0 : left.querySelector(".active-indicator");
      var activeItem = wrapper.querySelector(".content-item.is-active");
      var mainImage = wrapper.querySelector(".main-image");
      if (!left || !indicator || !activeItem || !mainImage) return;

      // SET IMAGE BAN ĐẦU
      var url = activeItem.getAttribute("data-media");
      if (url) mainImage.src = url;

      // MOVE INDICATOR
      var itemRect = activeItem.getBoundingClientRect();
      var leftRect = left.getBoundingClientRect();
      indicator.style.height = "".concat(itemRect.height, "px");
      indicator.style.transform = "translateY(".concat(itemRect.top - leftRect.top, "px)");
    };
    ...
    // ======================
    document.addEventListener("click", function (e) {
      var item = e.target.closest(".flip-content-media .content-item");
      if (!item) return;
      var wrapper = item.closest(".flip-content-media");
      if (!wrapper) return;
      var left = wrapper.querySelector(".thumb-list");
      var indicator = left === null || left === void 0 ? void 0 : left.querySelector(".active-indicator");
      var mainImage = wrapper.querySelector(".main-image");
      ...
      // ACTIVE
      wrapper.querySelectorAll(".content-item").forEach(function (el) {
      ...
      // SWAP IMAGE
      var url = item.getAttribute("data-media");
      if (url) mainImage.src = url;
    });
    ...
    window.addEventListener("load", function () {
      document.querySelectorAll(".flip-content-media").forEach(function (wrapper) {
        return initBlock(wrapper);
      });
    });
  }
};
},{}],"blocks/services-popup.js":[function(require,module,exports) {
"use strict";
...
var _default = exports.default = {
  init: function init() {
    ...
    var popups = document.querySelectorAll(".service-popup");
    ...
    cards.forEach(function (card) {
      card.addEventListener("click", function () {
        return openPopup(card.dataset.serviceId);
      });
    ...
    popups.forEach(function (popup) {
      var _popup$querySelector;
      (_popup$querySelector = popup.querySelector(".service-popup__close")) === null || _popup$querySelector === void 0 || _popup$querySelector.addEventListener("click", closeAll);
    ...
    function openPopup(id) {
      var target = document.querySelector(".service-popup[data-id=\"".concat(id, "\"]"));
      if (!target) return;
      closeAll(false);
      target.classList.add("is-active");

      // reset panel scroll to top (scroll is on the panel, not the wrapper)
      var panel = target.querySelector(".service-popup__panel");
      ...
      var firstFocusable = target.querySelector('button, [href], input, [tabindex]:not([tabindex="-1"])');
      firstFocusable === null || firstFocusable === void 0 || firstFocusable.focus();
    }
    function closeAll() {
      var restoreScroll = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;
...
},{}],"blocks/products-popup.js":[function(require,module,exports) {
"use strict";
...
var _default = exports.default = {
  init: function init() {
    ...
    var popups = document.querySelectorAll(".product-popup");
    if (!cards.length || !popups.length) return;

    /* ── Open ────────────────────────────────────── */
    cards.forEach(function (card) {
      card.addEventListener("click", function () {
        return openPopup(card.dataset.productId);
      });
      card.addEventListener("keydown", function (e) {
        if (e.key === "Enter" || e.key === " ") {
          e.preventDefault();
    ...
    popups.forEach(function (popup) {
      var _popup$querySelector;
      (_popup$querySelector = popup.querySelector(".product-popup__close")) === null || _popup$querySelector === void 0 || _popup$querySelector.addEventListener("click", closeAll);
      popup.addEventListener("click", function (e) {
    ...
    /* ── Helpers ─────────────────────────────────── */
    function openPopup(id) {
      var target = document.querySelector(".product-popup[data-id=\"".concat(id, "\"]"));
      if (!target) return;
      closeAll(false);
      target.classList.add("is-active");
      var panel = target.querySelector(".product-popup__panel");
      if (panel) panel.scrollTop = 0;
      document.body.style.overflow = "hidden";
      var firstFocusable = target.querySelector('button, [href], input, [tabindex]:not([tabindex="-1"])');
      firstFocusable === null || firstFocusable === void 0 || firstFocusable.focus();
    ...
    function initGallery(popup) {
      var gallery = popup.querySelector(".product-popup__gallery");
      if (!gallery) return;
      var slides = Array.from(gallery.querySelectorAll(".product-popup__gallery-slide"));
      var dots = Array.from(gallery.querySelectorAll(".product-popup__gallery-dot"));
      var prevBtn = gallery.querySelector(".product-popup__gallery-nav--prev");
      var nextBtn = gallery.querySelector(".product-popup__gallery-nav--next");
      if (slides.length <= 1) return;
      var current = 0;
      function goTo(index) {
        var _dots$current, _dots$current2;
        slides[current].classList.remove("is-active");
        (_dots$current = dots[current]) === null || _dots$current === void 0 || _dots$current.classList.remove("is-active");
        current = (index + slides.length) % slides.length;
        slides[current].classList.add("is-active");
        (_dots$current2 = dots[current]) === null || _dots$current2 === void 0 || _dots$current2.classList.add("is-active");
      }
      prevBtn === null || prevBtn === void 0 || prevBtn.addEventListener("click", function (e) {
        e.stopPropagation();
        goTo(current - 1);
      });
      nextBtn === null || nextBtn === void 0 || nextBtn.addEventListener("click", function (e) {
        e.stopPropagation();
        goTo(current + 1);
      });
...
},{}],"blocks/popup-button.js":[function(require,module,exports) {
"use strict";
...
var _default = exports.default = {
  init: function init() {
    var triggers = document.querySelectorAll(".popup-trigger-btn[data-popup-target]");
    ...
    triggers.forEach(function (btn) {
      btn.addEventListener("click", function () {
        return openPopup(btn.dataset.popupTarget);
      });
    ...
    document.addEventListener("click", function (e) {
      var overlay = e.target.closest(".popup-overlay");
    ...
    // ── Helpers ───────────────────────────────────────────────────────────────
    function openPopup(id) {
      var overlay = document.getElementById("popup-".concat(id));
      if (!overlay) return;
      closeAll(false);
      ...
      requestAnimationFrame(function () {
        var focusable = overlay.querySelector('.popup-close, button, [href], input, [tabindex]:not([tabindex="-1"])');
    ...
    function closeAll() {
      var restoreScroll = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;
      document.querySelectorAll(".popup-overlay.is-active").forEach(function (overlay) {
    ...
    function trapFocus(e) {
      ...
      var focusableEls = Array.from(overlay.querySelectorAll('button, [href], input, select, textarea, [tabindex]:not([tabindex="-1"])')).filter(function (el) {
...
var _counter = _interopRequireDefault(require("./blocks/counter"));
var _carouselSlider = _interopRequireDefault(require("./blocks/carousel-slider"));
var _insights = _interopRequireDefault(require("./blocks/insights"));
var _team = _interopRequireDefault(require("./blocks/team"));
var _teamExperts = _interopRequireDefault(require("./blocks/team-experts"));
var _sectors = _interopRequireDefault(require("./blocks/sectors"));
var _contentMedia = _interopRequireDefault(require("./blocks/content-media"));
var _servicesPopup = _interopRequireDefault(require("./blocks/services-popup"));
var _productsPopup = _interopRequireDefault(require("./blocks/products-popup"));
var _popupButton = _interopRequireDefault(require("./blocks/popup-button"));
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
...
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } // Import components for blocks and functionality
document.addEventListener("DOMContentLoaded", /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
  return _regenerator().w(function (_context) {
    while (1) switch (_context.n) {
      case 0:
        _functions.default.init();
        _counter.default.init();
        _carouselSlider.default.init();
        _insights.default.init();
        _team.default.init();
        _teamExperts.default.init();
        _sectors.default.init();
        _contentMedia.default.init();
        _servicesPopup.default.init();
        _productsPopup.default.init();
        _popupButton.default.init();
      case 1:
        return _context.a(2);
    }
  }, _callee);
})));
},{"./functions":"functions.js","./blocks/counter":"blocks/counter.js","./blocks/carousel-slider":"blocks/carousel-slider.js","./blocks/insights":"blocks/insights.js","./blocks/team":"blocks/team.js","./blocks/team-experts":"blocks/team-experts.js","./blocks/sectors":"blocks/sectors.js","./blocks/content-media":"blocks/content-media.js","./blocks/services-popup":"blocks/services-popup.js","./blocks/products-popup":"blocks/products-popup.js","./blocks/popup-button":"blocks/popup-button.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
